...
<script type = "text/javascript">
   ...
   $('#RegisterEventID').click(function(){
      ...
      var event_data = {'event_id':event_id, 'event_name':event_name, 'event_des':event_des, 'event_type':event_type, event_payment_method:event_payment_method, event_pay_acc_no:event_pay_acc_no, 'event_date':event_date, 'event_time':event_time, 'event_venue':event_venue, 'event_fee':event_fee, 'countdown':countdown};
   ...
   function ViewEventDetails(eventDetailsid)
   {
      ...
      axios.post(url, {
         ...
         if(response.status == 200)
         {
            ...
            $('#countdown').val(JsonData[0].event_reg_last_date);
         }
         else
         {
