                            ...
                            <tbody id = "user_data">
                                @foreach ($EventMemberDetails as $EventMemberDetails)
                                    <tr>
                                        ...
                                        <td>
                                            <button name="submit" type="submit" data-id="{{$EventMemberDetails->user_phone_no}}" data-name="{{$EventMemberDetails->transaction_no}}" data-rid="{{$EventMemberDetails->id}}" data-toggle="modal" data-target="#PaymentApproveModal" class="submit status" >Update Status</button>
                                        </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="background-color: #464646">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="PaymentStatusUpdateConfirm" class="btn btn-primary">Update</button>
            </div>
        </div>
    </div>
</div>
